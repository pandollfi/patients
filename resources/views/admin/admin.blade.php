                                     ...
                                     <tbody>
                                         <tr>
                                             <th scope="row"><a href="#"><img
                                                         src="{{ url('assets_dashboard/img/product-1.jpg') }}"
                                                         alt=""></a></th>
                                         ...
                                         <tr>
                                             <th scope="row"><a href="#"><img
                                                         src="{{ url('assets_dashboard/img/product-2.jpg') }}"
                                                         alt=""></a></th>
                                         ...
                                         <tr>
                                             <th scope="row"><a href="#"><img
                                                         src="{{ url('assets_dashboard/img/product-3.jpg') }}"
                                                         alt=""></a></th>
                                         ...
                                         <tr>
                                             <th scope="row"><a href="#"><img
                                                         src="{{ url('assets_dashboard/img/product-4.jpg') }}"
                                                         alt=""></a></th>
                                         ...
                                         <tr>
                                             <th scope="row"><a href="#"><img
                                                         src="{{ url('assets_dashboard/img/product-5.jpg') }}"
                                                         alt=""></a></th>
                     ...
                     <div class="card-body pb-0">
                         ...
                         <div class="news">
                             <div class="post-item clearfix">
                                 <img src="{{ url('assets_dashboard/img/news-1.jpg') }}" alt="">
                                 <h4><a href="#">Nihil blanditiis at in nihil autem</a></h4>
                                 <p>Sit recusandae non aspernatur laboriosam. Quia enim eligendi sed ut harum...</p>
                             </div>

                             <div class="post-item clearfix">
                                 <img src="{{ url('assets_dashboard/img/news-2.jpg') }}" alt="">
                                 <h4><a href="#">Quidem autem et impedit</a></h4>
                                 <p>Illo nemo neque maiores vitae officiis cum eum turos elan dries werona nande...</p>
                             </div>

                             <div class="post-item clearfix">
                                 <img src="{{ url('assets_dashboard/img/news-3.jpg') }}" alt="">
                                 <h4><a href="#">Id quia et et ut maxime similique occaecati ut</a></h4>
                                 <p>Fugiat voluptas vero eaque accusantium eos. Consequuntur sed ipsam et totam...</p>
                             </div>

                             <div class="post-item clearfix">
                                 <img src="{{ url('assets_dashboard/img/news-4.jpg') }}" alt="">
                                 <h4><a href="#">Laborum corporis quo dara net para</a></h4>
                                 <p>Qui enim quia optio. Eligendi aut asperiores enim repellendusvel rerum cuder...</p>
                             </div>

                             <div class="post-item clearfix">
                                 <img src="{{ url('assets_dashboard/img/news-5.jpg') }}" alt="">
